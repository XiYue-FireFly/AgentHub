...
describe("parseCodexStreamJsonLine", () => {
  ...
  it("extracts usage from turn.completed lifecycle events", () => {
    expect(parseCodexStreamJsonLine(JSON.stringify({ type: "turn.completed", usage: { input_tokens: 1, output_tokens: 2 } }))).toEqual({
