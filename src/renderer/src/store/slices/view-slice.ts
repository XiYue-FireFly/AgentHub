...
export type SettingsTabKey = 'providers' | 'local-agents' | 'routing' | 'mcp' | 'appearance' | 'memory' | 'updates' | 'shortcuts' | 'models' | 'plugins' | 'usage' | 'approvals' | 'workspaces' | 'skills' | 'agentLoop' | 'requirements'
