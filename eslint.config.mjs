...
// LOW-44: Shared rules used across all file scopes
const sharedRules = {
...
export default tseslint.config(
  ...
  // LOW-44: Main/preload files use Node.js globals
  {
  ...
  // LOW-44: Renderer files use browser globals
  {
  ...
  // LOW-44: Shared types and test files need both environments
  {
    files: ['src/shared/**/*.{ts,tsx}', 'test/**/*.{ts,tsx}'],
    languageOptions: {
